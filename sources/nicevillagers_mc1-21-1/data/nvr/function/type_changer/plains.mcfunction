advancement revoke @s only nvr:type_changer/plains
...
data modify entity @n[type=villager,nbt={VillagerData: {profession:"minecraft:none"}}] VillagerData.type set value "minecraft:plains"
