...
execute if score $villager_msg nvr.technical matches 1 run function nvr:talking/messages/logical/ancient_builder
execute if score $villager_msg nvr.technical matches 2 run function nvr:talking/messages/logical/redstone
...
advancement revoke @s only nvr:talking/logical