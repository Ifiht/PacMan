...
data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:rabbit_spawn_egg", count:1, components:{"minecraft:custom_model_data":314001}}], HandItems:[{id: "minecraft:structure_block", count: 1, components:{"minecraft:custom_model_data":312002}}, {}]} 
setblock ~ ~ ~ barrel{Items:[{Slot:26b, id:"minecraft:structure_block", count:1, components:{"minecraft:custom_model_data":312001, "minecraft:custom_data":{gui:1b}, "minecraft:hide_tooltip":{}, "minecraft:item_name":'{"text":""}'}}]}
