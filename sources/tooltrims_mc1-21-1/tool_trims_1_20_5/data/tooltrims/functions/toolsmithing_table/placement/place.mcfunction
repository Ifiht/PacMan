...
data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:rabbit_spawn_egg", Count:1b, components:{"minecraft:custom_model_data":314001}}], HandItems:[{id: "minecraft:structure_block", Count: 1b, components:{"minecraft:custom_model_data":312002}}, {}]} 
setblock ~ ~ ~ barrel{Items:[{Slot:26b, id:"minecraft:structure_block", Count:1b, components:{"minecraft:custom_model_data":312001, "minecraft:custom_data":{gui:1b}, "minecraft:item_name":'{"text":""}'}}]}
