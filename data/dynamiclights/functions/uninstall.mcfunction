...
datapack disable "file/dynamiclights-v1.8.3-mc1.17x-1.21x-datapack.zip"

say ⏻ Dynamic Lights v1.8.3 by Tschipcraft has been uninstalled by @s! It is safe to disable and remove the data pack/mod.
